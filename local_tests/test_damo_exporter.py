...
from hhnk_threedi_tools.core.schematisation_builder.DAMO_exporter import DB_exporter
from hhnk_threedi_tools.tests.config import TEMP_DIR, TEST_DIRECTORY
...
def test_DB_exporter_one_DAMO_feature():
...
if __name__ == "__main__":
    test_DB_exporter_one_DAMO_feature()
    test_DB_exporter_GEMAAL_and_POMP_from_CSO
    test_DB_exporter_polders()
