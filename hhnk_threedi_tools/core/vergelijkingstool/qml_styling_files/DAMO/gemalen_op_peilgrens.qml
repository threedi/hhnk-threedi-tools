...
<qgis labelsEnabled="1" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.34.4-Prizren" minScale="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{c6aa8d24-ee0b-4232-8a07-9f168ab8015f}">
      <rule scalemaxdenom="15000" filter="&quot;in_both&quot;   LIKE  '%both' AND  &quot;number_of_critical&quot; > 0" description="Aantal kritieke fouten" key="{e678dc33-87ec-4bb7-ab2b-f7737886de18}">
  ...
  <fieldConfiguration>
    ...
    <field name="aanslagpeil_rel_New" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="afslagpeil_rel_New" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="aanslagpeil_rel_Old" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="afslagpeil_rel_Old" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="cmp_modelleren_als" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="cmp_modelleren_als_priority" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="opmerkingen_New" index="5"/>
    <alias name="" field="aanslagpeil_rel_New" index="6"/>
    <alias name="" field="afslagpeil_rel_New" index="7"/>
    <alias name="" field="moet_op_peilgrens_New" index="8"/>
    <alias name="" field="geom_type_New" index="9"/>
    <alias name="" field="geom_length_New" index="10"/>
    <alias name="" field="geom_area_New" index="11"/>
    <alias name="" field="dataset_New" index="12"/>
    <alias name="" field="origin_New" index="13"/>
    <alias name="" field="ws_categorie_Old" index="14"/>
    <alias name="" field="opmerkingen_Old" index="15"/>
    <alias name="" field="aanslagpeil_rel_Old" index="16"/>
    <alias name="" field="afslagpeil_rel_Old" index="17"/>
    <alias name="" field="moet_op_peilgrens_Old" index="18"/>
    <alias name="" field="geom_length_Old" index="19"/>
    <alias name="" field="geom_area_Old" index="20"/>
    <alias name="" field="dataset_Old" index="21"/>
    <alias name="" field="origin_Old" index="22"/>
    <alias name="" field="in_both" index="23"/>
    <alias name="" field="geometry_adjusted" index="24"/>
    <alias name="" field="cmp_modelleren_als" index="25"/>
    <alias name="" field="cmp_modelleren_als_priority" index="26"/>
    <alias name="" field="cmp_categorie" index="27"/>
    <alias name="" field="cmp_categorie_priority" index="28"/>
  ...
  <defaults>
    ...
    <default expression="" field="aanslagpeil_rel_New" applyOnUpdate="0"/>
    <default expression="" field="afslagpeil_rel_New" applyOnUpdate="0"/>
    ...
    <default expression="" field="aanslagpeil_rel_Old" applyOnUpdate="0"/>
    <default expression="" field="afslagpeil_rel_Old" applyOnUpdate="0"/>
    ...
    <default expression="" field="cmp_modelleren_als" applyOnUpdate="0"/>
    <default expression="" field="cmp_modelleren_als_priority" applyOnUpdate="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="aanslagpeil_rel_New" exp="" desc=""/>
    <constraint field="afslagpeil_rel_New" exp="" desc=""/>
    ...
    <constraint field="aanslagpeil_rel_Old" exp="" desc=""/>
    <constraint field="afslagpeil_rel_Old" exp="" desc=""/>
    ...
    <constraint field="cmp_modelleren_als" exp="" desc=""/>
    <constraint field="cmp_modelleren_als_priority" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;number_of_critical&quot;">
    <columns>
      ...
      <column name="aanslagpeil_rel_New" hidden="0" width="-1" type="field"/>
      <column name="afslagpeil_rel_New" hidden="0" width="-1" type="field"/>
      <column name="moet_op_peilgrens_New" hidden="0" width="-1" type="field"/>
      <column name="opmerkingen_Old" hidden="0" width="-1" type="field"/>
      <column name="aanslagpeil_rel_Old" hidden="0" width="-1" type="field"/>
      <column name="afslagpeil_rel_Old" hidden="0" width="-1" type="field"/>
      <column name="moet_op_peilgrens_Old" hidden="0" width="-1" type="field"/>
      <column name="cmp_modelleren_als" hidden="0" width="-1" type="field"/>
      <column name="cmp_modelleren_als_priority" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" name="ID" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="naam_New" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="naam_Old" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_ID" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_ID_priority" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Category" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="ws_categorie_Old" verticalStretch="0" showLabel="1" index="14">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_categorie" verticalStretch="0" showLabel="1" index="27">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_categorie_priority" verticalStretch="0" showLabel="1" index="28">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Capacity" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="maximalecapaciteit_New" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="maximalecapaciteit_Old" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_maximalecapaciteit" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_maximalecapaciteit_change_NaN" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_maximalecapaciteit_priority" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Dataset_Origin" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorContainer horizontalStretch="0" name="Dataset" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="dataset_Old" verticalStretch="0" showLabel="1" index="21">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" name="Origin" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="origin_Old" verticalStretch="0" showLabel="1" index="22">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      </attributeEditorContainer>
      <attributeEditorField horizontalStretch="0" name="in_both" verticalStretch="0" showLabel="1" index="23">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Function" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="functiegemaal_New" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="functiegemaal_Old" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_functiegemaal" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_functiegemaal_priority" verticalStretch="0" showLabel="1" index="-1">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Geometry" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorContainer horizontalStretch="0" name="Area" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="geom_area_Old" verticalStretch="0" showLabel="1" index="20">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" name="Length" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="geom_length_New" verticalStretch="0" showLabel="1" index="10">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" name="Type" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="geom_type_New" verticalStretch="0" showLabel="1" index="9">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="geom_type_Old" verticalStretch="0" showLabel="1" index="-1">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorField horizontalStretch="0" name="geometry_adjusted" verticalStretch="0" showLabel="1" index="24">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="aanslagpeil_rel_New" editable="1"/>
    <field name="aanslagpeil_rel_Old" editable="1"/>
    <field name="aantal_doorstroomopeningen_A" editable="1"/>
    <field name="aantal_doorstroomopeningen_B" editable="1"/>
    <field name="afslagpeil_rel_New" editable="1"/>
    <field name="afslagpeil_rel_Old" editable="1"/>
    ...
    <field name="cmp_modelleren_als" editable="1"/>
    <field name="cmp_modelleren_als_priority" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="aanslagpeil_rel_New" labelOnTop="0"/>
    <field name="aanslagpeil_rel_Old" labelOnTop="0"/>
    <field name="aantal_doorstroomopeningen_A" labelOnTop="0"/>
    <field name="aantal_doorstroomopeningen_B" labelOnTop="0"/>
    <field name="afslagpeil_rel_New" labelOnTop="0"/>
    <field name="afslagpeil_rel_Old" labelOnTop="0"/>
    ...
    <field name="cmp_modelleren_als" labelOnTop="0"/>
    <field name="cmp_modelleren_als_priority" labelOnTop="0"/>
