...
<qgis labelsEnabled="1" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.34.4-Prizren" minScale="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{88752be4-0bb4-4d7b-affa-e431e3522442}">
      <rule scalemaxdenom="15000" filter="&quot;in_both&quot;   LIKE  '%both' AND  &quot;number_of_critical&quot; > 0" description="Aantal kritieke fouten" key="{ed6febb3-83ee-4866-81ec-7f187690001f}">
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;cmp_hoogteonderzijde_change_NaN&quot;">
    <columns>
      ...
      <column name="som_doorstroombreedte_Old" hidden="0" width="188" type="field"/>
