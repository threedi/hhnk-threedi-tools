...
<qgis labelsEnabled="0" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="1" version="3.34.4-Prizren" minScale="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" symbologyReferenceScale="-1">
  ...
  <fieldConfiguration>
    ...
    <field name="material_New" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="crest_level_New" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="max_breach_depth_New" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="id_New" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="fid_Old" configurationFlags="NoFlag">
    ...
    <field name="material_Old" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="crest_level_Old" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="max_breach_depth_Old" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="id_Old" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="cmp_material" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="cmp_material_priority" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="cmp_crest_level" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="cmp_crest_level_priority" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="cmp_max_breach_depth" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="cmp_max_breach_depth_priority" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias name="" field="material_New" index="4"/>
    <alias name="" field="crest_level_New" index="5"/>
    <alias name="" field="max_breach_depth_New" index="6"/>
    <alias name="" field="id_New" index="7"/>
    <alias name="" field="geom_length_New" index="8"/>
    <alias name="" field="shape_length_New" index="9"/>
    <alias name="" field="geom_type_New" index="10"/>
    <alias name="" field="geom_area_New" index="11"/>
    <alias name="" field="dataset_New" index="12"/>
    <alias name="" field="origin_New" index="13"/>
    <alias name="" field="fid_Old" index="14"/>
    <alias name="" field="material_Old" index="15"/>
    <alias name="" field="crest_level_Old" index="16"/>
    <alias name="" field="max_breach_depth_Old" index="17"/>
    <alias name="" field="id_Old" index="18"/>
    <alias name="" field="geom_length_Old" index="19"/>
    <alias name="" field="shape_length_Old" index="20"/>
    <alias name="" field="geom_type_Old" index="21"/>
    <alias name="" field="geom_area_Old" index="22"/>
    <alias name="" field="dataset_Old" index="23"/>
    <alias name="" field="origin_Old" index="24"/>
    <alias name="" field="in_both" index="25"/>
    <alias name="" field="geometry_adjusted" index="26"/>
    <alias name="" field="cmp_material" index="27"/>
    <alias name="" field="cmp_material_priority" index="28"/>
    <alias name="" field="cmp_crest_level" index="29"/>
    <alias name="" field="cmp_crest_level_priority" index="30"/>
    <alias name="" field="cmp_max_breach_depth" index="31"/>
    <alias name="" field="cmp_max_breach_depth_priority" index="32"/>
    <alias name="" field="cmp_ID" index="33"/>
    <alias name="" field="cmp_ID_priority" index="34"/>
    <alias name="" field="cmp_geom_length" index="35"/>
    <alias name="" field="cmp_geom_length_change_NaN" index="36"/>
    <alias name="" field="cmp_geom_length_priority" index="37"/>
  ...
  <defaults>
    ...
    <default expression="" field="material_New" applyOnUpdate="0"/>
    <default expression="" field="crest_level_New" applyOnUpdate="0"/>
    <default expression="" field="max_breach_depth_New" applyOnUpdate="0"/>
    <default expression="" field="id_New" applyOnUpdate="0"/>
    ...
    <default expression="" field="fid_Old" applyOnUpdate="0"/>
    <default expression="" field="material_Old" applyOnUpdate="0"/>
    <default expression="" field="crest_level_Old" applyOnUpdate="0"/>
    <default expression="" field="max_breach_depth_Old" applyOnUpdate="0"/>
    <default expression="" field="id_Old" applyOnUpdate="0"/>
    ...
    <default expression="" field="cmp_material" applyOnUpdate="0"/>
    <default expression="" field="cmp_material_priority" applyOnUpdate="0"/>
    <default expression="" field="cmp_crest_level" applyOnUpdate="0"/>
    <default expression="" field="cmp_crest_level_priority" applyOnUpdate="0"/>
    <default expression="" field="cmp_max_breach_depth" applyOnUpdate="0"/>
    <default expression="" field="cmp_max_breach_depth_priority" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="material_New" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="crest_level_New" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="max_breach_depth_New" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="id_New" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="fid_Old" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="material_Old" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="crest_level_Old" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="max_breach_depth_Old" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="id_Old" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="cmp_material" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_material_priority" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_crest_level" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_crest_level_priority" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_max_breach_depth" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_max_breach_depth_priority" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="material_New" exp="" desc=""/>
    <constraint field="crest_level_New" exp="" desc=""/>
    <constraint field="max_breach_depth_New" exp="" desc=""/>
    <constraint field="id_New" exp="" desc=""/>
    ...
    <constraint field="fid_Old" exp="" desc=""/>
    <constraint field="material_Old" exp="" desc=""/>
    <constraint field="crest_level_Old" exp="" desc=""/>
    <constraint field="max_breach_depth_Old" exp="" desc=""/>
    <constraint field="id_Old" exp="" desc=""/>
    ...
    <constraint field="cmp_material" exp="" desc=""/>
    <constraint field="cmp_material_priority" exp="" desc=""/>
    <constraint field="cmp_crest_level" exp="" desc=""/>
    <constraint field="cmp_crest_level_priority" exp="" desc=""/>
    <constraint field="cmp_max_breach_depth" exp="" desc=""/>
    <constraint field="cmp_max_breach_depth_priority" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;geometry_adjusted&quot;">
    <columns>
      ...
      <column name="material_New" hidden="0" width="-1" type="field"/>
      <column name="crest_level_New" hidden="0" width="-1" type="field"/>
      <column name="max_breach_depth_New" hidden="0" width="-1" type="field"/>
      <column name="id_New" hidden="0" width="-1" type="field"/>
      ...
      <column name="fid_Old" hidden="0" width="-1" type="field"/>
      <column name="material_Old" hidden="0" width="-1" type="field"/>
      <column name="crest_level_Old" hidden="0" width="-1" type="field"/>
      <column name="max_breach_depth_Old" hidden="0" width="-1" type="field"/>
      <column name="id_Old" hidden="0" width="-1" type="field"/>
      ...
      <column name="cmp_material" hidden="0" width="-1" type="field"/>
      <column name="cmp_material_priority" hidden="0" width="-1" type="field"/>
      <column name="cmp_crest_level" hidden="0" width="-1" type="field"/>
      <column name="cmp_crest_level_priority" hidden="0" width="-1" type="field"/>
      <column name="cmp_max_breach_depth" hidden="0" width="-1" type="field"/>
      <column name="cmp_max_breach_depth_priority" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" name="ID" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="id_New" verticalStretch="0" showLabel="1" index="7">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="id_Old" verticalStretch="0" showLabel="1" index="18">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_ID" verticalStretch="0" showLabel="1" index="33">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_ID_priority" verticalStretch="0" showLabel="1" index="34">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Crest_Level" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="crest_level_New" verticalStretch="0" showLabel="1" index="5">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="crest_level_Old" verticalStretch="0" showLabel="1" index="16">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_crest_level" verticalStretch="0" showLabel="1" index="29">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_crest_level_priority" verticalStretch="0" showLabel="1" index="30">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Dataset_Origin" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorContainer horizontalStretch="0" name="Origin" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="origin_New" verticalStretch="0" showLabel="1" index="13">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="origin_Old" verticalStretch="0" showLabel="1" index="24">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" name="Dataset" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="dataset_New" verticalStretch="0" showLabel="1" index="12">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="dataset_Old" verticalStretch="0" showLabel="1" index="23">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      </attributeEditorContainer>
      <attributeEditorField horizontalStretch="0" name="in_both" verticalStretch="0" showLabel="1" index="25">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Material" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="material_New" verticalStretch="0" showLabel="1" index="4">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="material_Old" verticalStretch="0" showLabel="1" index="15">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_material" verticalStretch="0" showLabel="1" index="27">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_material_priority" verticalStretch="0" showLabel="1" index="28">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    </attributeEditorContainer>
    <attributeEditorContainer horizontalStretch="0" name="Max_Breach_Depth" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="1">
        <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,75,0,0,0,0,0" bold="1"/>
      </labelStyle>
      <attributeEditorField horizontalStretch="0" name="max_breach_depth_New" verticalStretch="0" showLabel="1" index="6">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="max_breach_depth_Old" verticalStretch="0" showLabel="1" index="17">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_max_breach_depth" verticalStretch="0" showLabel="1" index="31">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_max_breach_depth_priority" verticalStretch="0" showLabel="1" index="32">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Geometry" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorContainer horizontalStretch="0" name="Length" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="geom_length_New" verticalStretch="0" showLabel="1" index="8">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="shape_length_New" verticalStretch="0" showLabel="1" index="9">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="geom_length_Old" verticalStretch="0" showLabel="1" index="19">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="shape_length_Old" verticalStretch="0" showLabel="1" index="20">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="cmp_geom_length_priority" verticalStretch="0" showLabel="1" index="37">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="cmp_geom_length_change_NaN" verticalStretch="0" showLabel="1" index="36">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="cmp_geom_length" verticalStretch="0" showLabel="1" index="35">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" name="Area" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="geom_area_New" verticalStretch="0" showLabel="1" index="11">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="geom_area_Old" verticalStretch="0" showLabel="1" index="22">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorField horizontalStretch="0" name="geometry_adjusted" verticalStretch="0" showLabel="1" index="26">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    ...
    <field name="cmp_crest_level" editable="1"/>
    <field name="cmp_crest_level_priority" editable="1"/>
    ...
    <field name="cmp_material" editable="1"/>
    <field name="cmp_material_priority" editable="1"/>
    <field name="cmp_max_breach_depth" editable="1"/>
    <field name="cmp_max_breach_depth_priority" editable="1"/>
    ...
    <field name="crest_level_New" editable="1"/>
    <field name="crest_level_Old" editable="1"/>
    ...
    <field name="id_New" editable="1"/>
    <field name="id_Old" editable="1"/>
    ...
    <field name="material_New" editable="1"/>
    <field name="material_Old" editable="1"/>
    <field name="max_breach_depth_New" editable="1"/>
    <field name="max_breach_depth_Old" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="cmp_crest_level" labelOnTop="0"/>
    <field name="cmp_crest_level_priority" labelOnTop="0"/>
    ...
    <field name="cmp_material" labelOnTop="0"/>
    <field name="cmp_material_priority" labelOnTop="0"/>
    <field name="cmp_max_breach_depth" labelOnTop="0"/>
    <field name="cmp_max_breach_depth_priority" labelOnTop="0"/>
    ...
    <field name="crest_level_New" labelOnTop="0"/>
    <field name="crest_level_Old" labelOnTop="0"/>
    ...
    <field name="fid_Old" labelOnTop="0"/>
    ...
    <field name="id_New" labelOnTop="0"/>
    <field name="id_Old" labelOnTop="0"/>
    ...
    <field name="material_New" labelOnTop="0"/>
    <field name="material_Old" labelOnTop="0"/>
    <field name="max_breach_depth_New" labelOnTop="0"/>
    <field name="max_breach_depth_Old" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="cmp_crest_level"/>
    <field reuseLastValue="0" name="cmp_crest_level_priority"/>
    ...
    <field reuseLastValue="0" name="cmp_material"/>
    <field reuseLastValue="0" name="cmp_material_priority"/>
    <field reuseLastValue="0" name="cmp_max_breach_depth"/>
    <field reuseLastValue="0" name="cmp_max_breach_depth_priority"/>
    ...
    <field reuseLastValue="0" name="crest_level_New"/>
    <field reuseLastValue="0" name="crest_level_Old"/>
    ...
    <field reuseLastValue="0" name="fid_Old"/>
    ...
    <field reuseLastValue="0" name="id_New"/>
    <field reuseLastValue="0" name="id_Old"/>
    ...
    <field reuseLastValue="0" name="material_New"/>
    <field reuseLastValue="0" name="material_Old"/>
    <field reuseLastValue="0" name="max_breach_depth_New"/>
    <field reuseLastValue="0" name="max_breach_depth_Old"/>
