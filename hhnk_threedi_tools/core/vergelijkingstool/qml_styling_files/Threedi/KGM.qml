...
<qgis labelsEnabled="1" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.34.4-Prizren" minScale="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" symbologyReferenceScale="-1">
  ...
  <labeling type="rule-based">
    <rules key="{910dce63-31ca-4155-832d-d28d0bb7e38e}">
      <rule scalemaxdenom="15000" filter="&quot;in_both&quot;   LIKE  '%both' AND  &quot;number_of_critical&quot; > 0" description="Aantal kritieke fouten" key="{af28895c-432d-4871-8366-43c9239026b7}">
  ...
  <fieldConfiguration>
    ...
    <field name="capacity_model" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="aanslagpeil_rel_damo" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="afslagpeil_rel_damo" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="cmp_capaciteit" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
    ...
    <field name="cmp_capaciteit_change_NaN" configurationFlags="NoFlag">
      <editWidget type="CheckBox">
        <config>
          <Option type="Map">
            <Option name="AllowNullState" value="false" type="bool"/>
    ...
    <field name="cmp_capaciteit_priority" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" value="false" type="bool"/>
  ...
  <aliases>
    ...
    <alias name="" field="sewerage_model" index="5"/>
    <alias name="" field="type_model" index="6"/>
    <alias name="" field="start_level_model" index="7"/>
    <alias name="" field="lower_stop_level_model" index="8"/>
    <alias name="" field="upper_stop_level_model" index="9"/>
    <alias name="" field="capacity_model" index="10"/>
    <alias name="" field="connection_node_id_model" index="11"/>
    <alias name="" field="tags_model" index="12"/>
    <alias name="" field="origin_model" index="13"/>
    <alias name="" field="crest_level_model" index="14"/>
    <alias name="" field="crest_type_model" index="15"/>
    <alias name="" field="friction_value_model" index="16"/>
    <alias name="" field="friction_type_model" index="17"/>
    <alias name="" field="discharge_coefficient_positive_model" index="18"/>
    <alias name="" field="discharge_coefficient_negative_model" index="19"/>
    <alias name="" field="external_model" index="20"/>
    <alias name="" field="connection_node_id_start_model" index="21"/>
    <alias name="" field="connection_node_id_end_model" index="22"/>
    <alias name="" field="cross_section_table_model" index="23"/>
    <alias name="" field="cross_section_shape_model" index="24"/>
    <alias name="" field="cross_section_width_model" index="25"/>
    <alias name="" field="cross_section_height_model" index="26"/>
    <alias name="" field="material_id_model" index="27"/>
    <alias name="" field="cross_section_max_width_model" index="28"/>
    <alias name="" field="cross_section_max_height_model" index="29"/>
    <alias name="" field="geom_type_model" index="30"/>
    <alias name="" field="geom_length_model" index="31"/>
    <alias name="" field="geom_area_model" index="32"/>
    <alias name="" field="dataset_model" index="33"/>
    <alias name="" field="ws_categorie_damo" index="34"/>
    <alias name="" field="opmerkingen_damo" index="35"/>
    <alias name="" field="aanslagpeil_rel_damo" index="36"/>
    <alias name="" field="afslagpeil_rel_damo" index="37"/>
    <alias name="" field="moet_op_peilgrens_damo" index="38"/>
    <alias name="" field="origin_damo" index="39"/>
    <alias name="" field="naam_damo" index="40"/>
    <alias name="" field="functiegemaal_damo" index="41"/>
    <alias name="" field="maximalecapaciteit_damo" index="42"/>
    <alias name="" field="doorstroombreedte_damo" index="43"/>
    <alias name="" field="kruinbreedte_damo" index="44"/>
    <alias name="" field="laagstedoorstroomhoogte_damo" index="45"/>
    <alias name="" field="hoogstedoorstroomhoogte_damo" index="46"/>
    <alias name="" field="soortregelbaarheid_damo" index="47"/>
    <alias name="" field="ws_kruinvorm_damo" index="48"/>
    <alias name="" field="ws_functiestuw_damo" index="49"/>
    <alias name="" field="geom_type_damo" index="50"/>
    <alias name="" field="geom_length_damo" index="51"/>
    <alias name="" field="geom_area_damo" index="52"/>
    <alias name="" field="dataset_damo" index="53"/>
    <alias name="" field="in_both" index="54"/>
    <alias name="" field="cmp_capaciteit" index="55"/>
    <alias name="" field="cmp_capaciteit_change_NaN" index="56"/>
    <alias name="" field="cmp_capaciteit_priority" index="57"/>
    <alias name="" field="cmp_geometry_type" index="58"/>
    <alias name="" field="cmp_geometry_type_priority" index="59"/>
  ...
  <splitPolicies>
    ...
    <policy field="capacity_model" policy="DefaultValue"/>
    ...
    <policy field="crest_type_model" policy="DefaultValue"/>
    <policy field="friction_value_model" policy="Duplicate"/>
    <policy field="friction_type_model" policy="Duplicate"/>
    <policy field="discharge_coefficient_positive_model" policy="DefaultValue"/>
    <policy field="discharge_coefficient_negative_model" policy="DefaultValue"/>
    <policy field="external_model" policy="Duplicate"/>
    <policy field="connection_node_id_start_model" policy="DefaultValue"/>
    ...
    <policy field="aanslagpeil_rel_damo" policy="Duplicate"/>
    <policy field="afslagpeil_rel_damo" policy="Duplicate"/>
    ...
    <policy field="doorstroombreedte_damo" policy="Duplicate"/>
    ...
    <policy field="cmp_capaciteit" policy="DefaultValue"/>
    <policy field="cmp_capaciteit_change_NaN" policy="DefaultValue"/>
    <policy field="cmp_capaciteit_priority" policy="DefaultValue"/>
  ...
  <defaults>
    ...
    <default expression="" field="type_model" applyOnUpdate="0"/>
    <default expression="" field="start_level_model" applyOnUpdate="0"/>
    <default expression="" field="lower_stop_level_model" applyOnUpdate="0"/>
    <default expression="" field="upper_stop_level_model" applyOnUpdate="0"/>
    <default expression="" field="capacity_model" applyOnUpdate="0"/>
    <default expression="" field="connection_node_id_model" applyOnUpdate="0"/>
    ...
    <default expression="" field="aanslagpeil_rel_damo" applyOnUpdate="0"/>
    <default expression="" field="afslagpeil_rel_damo" applyOnUpdate="0"/>
    ...
    <default expression="" field="functiegemaal_damo" applyOnUpdate="0"/>
    <default expression="" field="maximalecapaciteit_damo" applyOnUpdate="0"/>
    ...
    <default expression="" field="cmp_capaciteit" applyOnUpdate="0"/>
    <default expression="" field="cmp_capaciteit_change_NaN" applyOnUpdate="0"/>
    <default expression="" field="cmp_capaciteit_priority" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="type_model" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="start_level_model" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="lower_stop_level_model" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="upper_stop_level_model" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="capacity_model" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="connection_node_id_model" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="aanslagpeil_rel_damo" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="afslagpeil_rel_damo" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="functiegemaal_damo" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="maximalecapaciteit_damo" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="cmp_capaciteit" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_capaciteit_change_NaN" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="cmp_capaciteit_priority" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="capacity_model" exp="" desc=""/>
    ...
    <constraint field="aanslagpeil_rel_damo" exp="" desc=""/>
    <constraint field="afslagpeil_rel_damo" exp="" desc=""/>
    ...
    <constraint field="cmp_capaciteit" exp="" desc=""/>
    <constraint field="cmp_capaciteit_change_NaN" exp="" desc=""/>
    <constraint field="cmp_capaciteit_priority" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;number_of_critical&quot;">
    <columns>
      ...
      <column name="type_model" hidden="0" width="-1" type="field"/>
      <column name="start_level_model" hidden="0" width="-1" type="field"/>
      <column name="lower_stop_level_model" hidden="0" width="-1" type="field"/>
      <column name="upper_stop_level_model" hidden="0" width="-1" type="field"/>
      <column name="capacity_model" hidden="0" width="-1" type="field"/>
      <column name="connection_node_id_model" hidden="0" width="-1" type="field"/>
      ...
      <column name="aanslagpeil_rel_damo" hidden="0" width="-1" type="field"/>
      <column name="afslagpeil_rel_damo" hidden="0" width="-1" type="field"/>
      <column name="moet_op_peilgrens_damo" hidden="0" width="-1" type="field"/>
      <column name="naam_damo" hidden="0" width="-1" type="field"/>
      <column name="functiegemaal_damo" hidden="0" width="-1" type="field"/>
      <column name="maximalecapaciteit_damo" hidden="0" width="-1" type="field"/>
      <column name="doorstroombreedte_damo" hidden="0" width="-1" type="field"/>
      <column name="kruinbreedte_damo" hidden="0" width="-1" type="field"/>
      <column name="laagstedoorstroomhoogte_damo" hidden="0" width="-1" type="field"/>
      <column name="hoogstedoorstroomhoogte_damo" hidden="0" width="-1" type="field"/>
      ...
      <column name="cmp_capaciteit" hidden="0" width="-1" type="field"/>
      <column name="cmp_capaciteit_change_NaN" hidden="0" width="-1" type="field"/>
      <column name="cmp_capaciteit_priority" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" name="ID" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorField horizontalStretch="0" name="naam_damo" verticalStretch="0" showLabel="1" index="40">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Dataset_Origin" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorContainer horizontalStretch="0" name="Dataset" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="dataset_model" verticalStretch="0" showLabel="1" index="33">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="dataset_damo" verticalStretch="0" showLabel="1" index="53">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
      ...
      <attributeEditorContainer horizontalStretch="0" name="Origin" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="origin_model" verticalStretch="0" showLabel="1" index="13">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="origin_damo" verticalStretch="0" showLabel="1" index="39">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Capaciteit" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="1">
        <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,75,0,0,0,0,0" bold="1"/>
      </labelStyle>
      <attributeEditorField horizontalStretch="0" name="capacity_model" verticalStretch="0" showLabel="1" index="10">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="maximalecapaciteit_damo" verticalStretch="0" showLabel="1" index="42">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_capaciteit" verticalStretch="0" showLabel="1" index="55">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_capaciteit_priority" verticalStretch="0" showLabel="1" index="57">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="cmp_capaciteit_change_NaN" verticalStretch="0" showLabel="1" index="56">
        <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
          <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
        </labelStyle>
      </attributeEditorField>
    ...
    <attributeEditorContainer horizontalStretch="0" name="Geometry" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="0" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="Tab">
      ...
      <attributeEditorContainer horizontalStretch="0" name="Type" collapsedExpression="" verticalStretch="0" collapsed="0" visibilityExpression="" showLabel="1" groupBox="1" collapsedExpressionEnabled="0" visibilityExpressionEnabled="0" columnCount="1" type="GroupBox">
        ...
        <attributeEditorField horizontalStretch="0" name="geom_type_model" verticalStretch="0" showLabel="1" index="30">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="geom_type_damo" verticalStretch="0" showLabel="1" index="50">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="cmp_geometry_type_priority" verticalStretch="0" showLabel="1" index="59">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
        <attributeEditorField horizontalStretch="0" name="cmp_geometry_type" verticalStretch="0" showLabel="1" index="58">
          <labelStyle labelColor="0,0,0,255" overrideLabelColor="0" overrideLabelFont="0">
            <labelFont underline="0" style="" italic="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0"/>
          </labelStyle>
        </attributeEditorField>
