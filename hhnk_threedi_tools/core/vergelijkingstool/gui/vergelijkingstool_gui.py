...
from ipywidgets import VBox, HBox, Label, Button, Text
from IPython.display import display, clear_output
from hhnk_threedi_tools.core.vergelijkingstool import main, config
...
def run_gui(
    ...
    HBox([output_folder_text, output_name_input])])
    ...
    def on_damo_checkbox_change(change: Any) -> None:
        ...
        with output_box:
            ...
            if change["new"]:
                ...
                damo_buttons = [
                    widgets.ToggleButton(description=l, layout=widgets.Layout(width="48%"))
                    for l in layers_damo
                ]
    ...
    def on_3di_checkbox_change(change: Any) -> None:
        ...
        with output_box:
            ...
            if change["new"]:
                ...
                threedi_buttons = [
                    widgets.ToggleButton(description=l, layout=widgets.Layout(width="48%"))
                    for l in threedi_layers
                ]
                damo_buttons = [
                    widgets.ToggleButton(description=l, layout=widgets.Layout(width="48%"))
                    for l in damo_layers
                ]
                code_buttons = [
                    widgets.ToggleButton(description=c, layout=widgets.Layout(width="48%"))
                    for c in codes
                ]
