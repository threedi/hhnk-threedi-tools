...
class IntermediateConverter:
    ...
    def __init__(self, raw_export_file_path: Path, logger: Optional[logging.Logger] = None):
...
class ProfileIntermediateConverter(IntermediateConverter):
    ...
    def load_layers(self):
        ...
        gecombineerde_peilen = self._load_and_validate(self.raw_export_file_path, "PEILGEBIEDPRAKTIJK")
