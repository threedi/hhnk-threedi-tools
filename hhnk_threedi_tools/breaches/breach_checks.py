...
<<<<<<< Updated upstream
sqlite_path = Path(r"H:\02.modellen\midden_zuid_pytest\work in progress\schematisation\midden_zuid_pytest.sqlite")
dem_path = Path(
    r"H:\02.modellen\midden_zuid_pytest\work in progress\schematisation\rasters\dem_schemer_midden_zuid_fix_compressed_v2.tif"
)
out_path = Path(r"H:\02.modellen\midden_zuid_pytest\work in progress\schematisation\gridadmin_midden_zuid_pytest.gpkg")
=======
...
=======
temp_sqlite_path = sqlite_path.parent / "tmp" / (sqlite_path.stem + "_copy.gpkg")
>>>>>>> Stashed changes
