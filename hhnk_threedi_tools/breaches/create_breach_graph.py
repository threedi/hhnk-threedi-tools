def create_breach_graph(scenarioname,time_sec,model_name,model_revision,breach_id,breach_depth,
    breach_wlev_upstream, breach_wlev_downstream, breach_q, breach_u, breach_width,
    fig_path_name):
    ...
    textstr = ('(Model: '+ model_name +
            #' #' + str(model_revision) + 
            ' Breach: ' + str(breach_id[0]) + 
            ' Bresdiepte: '+str(np.round(breach_depth[-1],1))+'m'
    ...
    plt.text(0.5, 0.9,'Waterstand rond de bres', horizontalalignment = 'center', verticalalignment = 'top', transform=ax0.transAxes, fontsize=13)
    plt.grid()
    ...
    plt.text(0.5, 0.9,'Debiet door de bres', horizontalalignment = 'center', verticalalignment = 'top', transform=ax.transAxes, fontsize=13)
    plt.grid()
    ...
    plt.text(0.5, 0.9,'Stroomsnelheid door de bres', horizontalalignment = 'center', verticalalignment = 'top', transform=ax1.transAxes, fontsize=13)
    ...
    plt.text(0.5, 0.2,'Breedte van de bres', horizontalalignment = 'center', verticalalignment = 'top', transform=ax2.transAxes, fontsize=13)
