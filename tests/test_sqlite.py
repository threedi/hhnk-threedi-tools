...
# Local imports
from hhnk_threedi_tools.core.checks.sqlite.sqlite_main import HhnkSchematisationChecks
...
self = HhnkSchematisationChecks(folder=FOLDER_TEST)
...
class TestSqlite:
    ...
    def __init__(self):
        self.sqlite_check = HhnkSchematisationChecks(folder=FOLDER_TEST)
